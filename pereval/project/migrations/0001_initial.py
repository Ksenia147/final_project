...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winter', models.CharField(choices=[('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2Б', '2Б'), ('2А', '2А')], default='1А', max_length=2, verbose_name='Зима')),
                ('summer', models.CharField(choices=[('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2Б', '2Б'), ('2А', '2А')], default='1А', max_length=2, verbose_name='Лето')),
                ('autumn', models.CharField(choices=[('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2Б', '2Б'), ('2А', '2А')], default='1А', max_length=2, verbose_name='Осень')),
                ('spring', models.CharField(choices=[('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2Б', '2Б'), ('2А', '2А')], default='1А', max_length=2, verbose_name='Весна')),
            ],
        ),
        migrations.CreateModel(
            name='MyUser',
